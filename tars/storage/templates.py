...
class UnInitializedtars(object):
    def _raise_error(self, *args, **kwargs):
        logger.warning('An tars instance is called before initialized')
    def __getattr__(self, value):
...
class ContactList(list):
    ...
    @property
    def core(self):
        return getattr(self, '_core', lambda: faketars)() or faketars
    @core.setter
    def core(self, value):
