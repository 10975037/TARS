...
class Core(object):
    def __init__(self):
        ...
        self.useHotReload, self.hotReloadDir = False, 'tars.pkl'
        ...
        ''' many messages are sent in a common way
            for demo
                .. code:: python
                    ...
                    @tars.msg_register(tars.content.CARD)
                    def reply(msg):
                        tars.send_raw_msg(msg['MsgType'], msg['Content'], msg['FromUserName'])
    ...
    def load_login_status(self, fileDir,
        ...
        '''
        raise NotImplementedError()
    def auto_login(self, hotReload=False, statusStorageDir='tars.pkl',
